...
- I learn best watching the instructor showing us what to do then doing it myself. I also enjoy the tutorials.
-  Which resources from this document helped you the most?
- The Try Git tutorial was very helpful. It was short and to the point.
-  Which resource (if any) was most frustrating? Why?
- Learn Git Branching was a fun interactive but there is way to much information giving to you on the pop ups.
-   How comfortable are you with the workflow (series of steps and git commands) we use to share work and responses?
- I am comfortable with the Git workflow, I still need more information to fully understand Centralized workflows. Also, I dont really understand how to move through different commits.
