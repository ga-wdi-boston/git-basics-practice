...
- Practice, practice, practice - referencing notes and such but actually doing the thing (at least) a few times.
-  Which resources from this document helped you the most?
- Try Git seemed to be the best
-  Which resource (if any) was most frustrating? Why?
- Learn Git Branching - cumbersome UI (bad pop ups blocking views so have to reopen instructions multiple times)
-   How comfortable are you with the workflow (series of steps and git commands) we use to share work and responses?
- 3/5 - need to have a reference on each step still but understand the concepts
